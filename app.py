...
def predict():
    ...
    if prediction ==0:
        return render_template('index.html', prediction_text="Will Cancel").format(prediction)
    else:
        return render_template('index.html', prediction_text="Will Not Cancel").format(prediction)
